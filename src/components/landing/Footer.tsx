...
export function Footer() {
  return (
    <footer className="relative border-t border-white/8 py-16 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="md:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4 w-fit group">
              ...
              <span className="text-[#f8fafc] font-semibold text-base">
                Flow<span className="gradient-text-brand">Split</span>
              </span>
            </Link>
            <p className="text-[#64748b] text-sm leading-relaxed max-w-sm">
              The intelligent group expense management platform. Track expenses, optimize
              settlements, and visualize money flow in real time.
            </p>
            <div className="flex items-center gap-3 mt-5">
              {[
                ...
                <a
                  ...
                  href={href}
                  aria-label={label}
                  className="w-9 h-9 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-[#64748b] hover:text-[#f8fafc] hover:bg-white/10 transition-all"
                >
          ...
          {/* Product */}
          <div>
            <h4 className="text-[#f8fafc] font-medium text-sm mb-4">Product</h4>
          ...
          {/* Company */}
          <div>
            <h4 className="text-[#f8fafc] font-medium text-sm mb-4">Company</h4>
            <ul className="space-y-3">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8 border-t border-white/8">
          <p className="text-[#475569] text-sm">
            © {new Date().getFullYear()} FlowSplit. Built with Next.js, MongoDB & ❤️
          </p>
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#22c55e]/10 border border-[#22c55e]/20">
            <span className="w-1.5 h-1.5 rounded-full bg-[#22c55e] animate-pulse" />
            <span className="text-xs text-[#4ade80]">All systems operational</span>
          </div>
        </div>
      </div>
    </footer>
